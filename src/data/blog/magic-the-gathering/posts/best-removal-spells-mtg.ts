...
export const bestRemovalSpellsMtg: BlogPost = {
  slug: 'best-removal-spells-mtg',
  game: 'magic-the-gathering',
  category: 'card-guides',
  topicCluster: 'removal',
  title: 'Best Removal Spells in MTG (2026) — Every Color Ranked',
  ...
  secondaryKeywords: [
    'best removal commander',
    'mtg removal by color',
    'best board wipes mtg',
    'budget removal mtg',
    'best white removal mtg',
    'cheap removal spells commander',
  ],
  ...
  readingTimeMin: 11,
  toc: [
    { id: 'what-makes-removal-good', label: 'What makes removal good', level: 2 },
    { id: 'best-white-removal', label: 'Best white removal', level: 2 },
    { id: 'best-blue-removal', label: 'Best blue removal', level: 2 },
    { id: 'best-black-removal', label: 'Best black removal', level: 2 },
    { id: 'best-red-removal', label: 'Best red removal', level: 2 },
    { id: 'best-green-removal', label: 'Best green removal', level: 2 },
    { id: 'best-multicolor-and-colorless-removal', label: 'Best multicolor and colorless removal', level: 2 },
    { id: 'board-wipes-worth-running', label: 'Board wipes worth running', level: 2 },
    { id: 'budget-removal-under-2', label: 'Budget removal under $2', level: 2 },
    { id: 'quick-action-checklist', label: 'Quick Action Checklist', level: 2 },
  ],
  content: `The cheapest way to win a Commander game is to kill the thing that was about to win it. Not ramp into your own haymaker. Not durdle on a wincon nobody can interact with. Just point a one-mana spell at the problem and watch the table exhale.
...
The mental shift for blue players is treating bounce and counters as your removal suite instead of waiting for a Doom Blade that does not exist in your colors. Our [best blue cards guide](/blog/magic-the-gathering/best-blue-cards-magic-the-gathering) goes deeper on the control package.
...
The honest read on green is that its targeted creature removal is conditional, but its permanent answers (Beast Within, Krosan Grip) are top tier. Our [best green cards guide](/blog/magic-the-gathering/best-green-cards-magic-the-gathering) covers the rest of the toolbox.
...
| Spell | Cost | Colors | What it answers |
| --- | --- | --- | --- |
| Anguished Unmaking | 3 | W/B | Exile any nonland permanent, pay 3 life |
| Assassin's Trophy | 2 | B/G | Destroy any permanent, controller ramps a basic |
| Despark | 2 | W/B | Exile a permanent with mana value 4+ |
| Maelstrom Pulse | 3 | B/G | Destroy any nonland permanent (and all copies) |
| Meteor Golem | 7 | Colorless | ETB destroys any noncreature permanent |
...
| Board wipe | Cost | Color | Why run it |
| --- | --- | --- | --- |
| Wrath of God | 4 | W | The clean default, no regeneration |
| Damnation | 4 | B | Wrath in black, same clean kill |
| Blasphemous Act | 9 (often 1) | R | 13 damage to all, cost drops per creature |
| Toxic Deluge | 3 + X life | B | Scales, beats indestructible |
| Farewell | 6 | W | Modal exile of multiple permanent types |
...
For terms like "modal," "overload," or "split second," check our [MTG glossary](/glossary/magic-the-gathering).
...
- Cross-check current prices and format legality before you buy, since both move every set.`,
  faq: [
    {
      question: 'What is the best removal spell in MTG?',
      answer: "Swords to Plowshares is the most efficient single-target removal ever printed: one white mana to exile any creature, with a lifegain drawback that almost never matters in a 40-life Commander pod. For flexibility, Beast Within and Anguished Unmaking are the best 'destroy or exile anything' answers, and Cyclonic Rift's overload is the strongest mass removal in casual play.",
    },
    {
      question: 'How many removal spells should a Commander deck run?',
      answer: "Run 8 to 10 dedicated single-target removal spells plus 2 to 4 board wipes. That's the floor for a deck that can answer threats consistently. If you're counting counterspells and bounce in blue as removal, you can lean a little lighter on hard removal, but most casual decks are well below this number and lose games because of it.",
    },
    {
      question: 'Does green have good removal in MTG?',
      answer: "Yes, green's removal is much better than its old reputation. Beast Within destroys any permanent at instant speed for three mana, and Krosan Grip kills artifacts and enchantments with split second so it can't be responded to. Green's targeted creature kill is conditional (mostly fight effects), but its permanent answers are genuinely top tier.",
    },
    {
      question: 'What is the best board wipe in Commander?',
      answer: "It depends on your deck. Toxic Deluge is the most flexible because it scales and gets around indestructible, Wrath of God and Damnation are the clean four-mana defaults, Blasphemous Act often costs one or two mana for 13 damage to everything, and Cyclonic Rift's overload is the strongest because it only hits opponents.",
    },
    {
      question: 'What is the best budget removal in MTG?',
      answer: "Most of the best removal is already cheap thanks to reprints. Swords to Plowshares, Beast Within, Generous Gift, Bloodchief's Thirst, Abrade, Pongify, and Despark are all functional staples that usually cost under $2 a copy. The most underrated budget picks are modal answers like Feed the Swarm and Return to Nature that handle artifacts and enchantments.",
    },
    {
      question: 'Is exile better than destroy for removal?',
      answer: "Exile is generally better because it gets around indestructible creatures, dodges death triggers, and removes recursion targets from the graveyard permanently. Swords to Plowshares, Path to Exile, Anguished Unmaking, and Deadly Rollick all exile, which is part of why they're top picks. Destroy effects are still fine and often cheaper, just slightly more answerable.",
    },
  ],
  internalLinks: [
    { href: '/blog/magic-the-gathering', anchor: 'Magic: The Gathering blog hub' },
    { href: '/blog/magic-the-gathering/best-white-cards-magic-the-gathering', anchor: 'best white cards guide' },
    ...
    { href: '/blog/magic-the-gathering/best-red-cards-magic-the-gathering', anchor: 'best red cards guide' },
    { href: '/blog/magic-the-gathering/best-green-cards-magic-the-gathering', anchor: 'best green cards guide' },
    { href: '/blog/magic-the-gathering/best-lands-commander-mtg', anchor: 'best Commander lands guide' },
  ...
  externalSources: [
    ...
    { url: 'https://magic.wizards.com/en/news/announcements', title: 'Wizards Announcements' },
  ],
  tldr: 'Removal is the most underbuilt category in casual Commander decks. Run 8 to 10 single-target answers plus 2 to 4 board wipes, prioritize cheap and flexible spells, and lean instant speed. Top picks by color: white Swords to Plowshares, blue Cyclonic Rift, black Toxic Deluge, red Lightning Bolt, green Beast Within, multicolor Anguished Unmaking, colorless Meteor Golem.',
  itemList: {
    name: 'Best Removal Spell Per Color (MTG 2026)',
    items: [
      { name: 'White: Swords to Plowshares', description: 'One mana to exile any creature, the cleanest single-target removal ever printed.' },
      { name: 'Blue: Cyclonic Rift', description: 'Overload for seven to bounce every opponent permanent at instant speed, a soft win button.' },
      { name: 'Black: Toxic Deluge', description: 'Scalable board wipe that beats indestructible and hexproof for three mana plus life.' },
      { name: 'Red: Lightning Bolt', description: 'Three damage to any target for one mana, the best burn spell ever printed.' },
      { name: 'Green: Beast Within', description: 'Destroy any permanent at instant speed for three mana, only giving up a trivial 3/3.' },
      { name: 'Multicolor: Anguished Unmaking', description: 'Exile any nonland permanent for three mana and three life, the gold standard for flexible interaction.' },
      { name: 'Colorless: Meteor Golem', description: 'A removal spell stapled to a body that any deck can run regardless of color identity.' },
    ],
  },
};
