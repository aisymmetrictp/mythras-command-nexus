...
Equipment is the buff that doesn't die when the creature dies. That single difference is why the good ones are so good: you pay once, and the value re-attaches to the next thing you cast. This is a ranking of the best Equipment in Magic, built primarily for [Commander](/blog/magic-the-gathering/mtg-commander-format-guide-how-to-start) because that's where Equipment lives its best life, with format notes for the cards that matter in Modern, Pioneer, and Pauper. Every card here was checked against Scryfall for current legality, and where something is banned somewhere, it's flagged.
...
- **The Reaver Cleaver** — {2}{R}, equip {3}. Gives +1/+1, trample, and "whenever this creature deals combat damage to a player or planeswalker, create that many Treasure tokens." Connect for 5 and you get five [Treasures](/blog/magic-the-gathering/best-mtg-treasure-payoffs) — it ramps you hard every time it hits. A strong aggressive-ramp Equipment in red Commander decks.
