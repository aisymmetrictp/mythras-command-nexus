...
If you are below two wipes, you have no answer to a board that goes wide faster than you can pick off threats one at a time — which describes every elf deck, every [token deck](/blog/magic-the-gathering/best-mtg-token-generators-commander), and every "I cast my five-drop and made three bodies" turn you will ever sit across from. Single-target [removal](/blog/magic-the-gathering/best-removal-spells-mtg) answers one problem. A wipe answers all of them at once, and that is the whole point.
