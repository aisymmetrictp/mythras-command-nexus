...
export const secretsOfStrixhavenBestStandardCards: BlogPost = {
  slug: 'secrets-of-strixhaven-best-standard-cards',
  game: 'magic-the-gathering',
  category: 'set-releases',
  topicCluster: 'set-review',
  title: 'Secrets of Strixhaven Tier List — 20 Cards That Actually Matter',
  metaDescription:
  ...
  secondaryKeywords: [
    'secrets of strixhaven tier list',
    'best ssh cards mtg',
    'strixhaven standout cards',
    'strixhaven mythic review',
    'flow state mtg',
    'ssh standard cards',
  ],
  ...
  readingTimeMin: 11,
  toc: [
    { id: 'the-five-colleges-quickly', label: 'The five colleges, quickly', level: 2 },
    { id: 's-tier', label: 'S-tier', level: 2 },
    { id: 'a-tier', label: 'A-tier', level: 2 },
    { id: 'b-tier', label: 'B-tier', level: 2 },
    { id: 'commander-only-standouts', label: 'Commander-only standouts', level: 2 },
    { id: 'cards-that-flopped', label: 'Cards that flopped', level: 2 },
    { id: 'how-the-may-18-bans-reshaped-which-ssh-cards-matter', label: 'How the May 18 bans reshaped which SSH cards matter', level: 2 },
    { id: 'quick-action-checklist', label: 'Quick Action Checklist', level: 2 },
  ],
  content: `Secrets of Strixhaven shipped 270-plus cards and most of them will never touch Standard play.
...
| ----------------------------- | ------ | -------- | ------------------------------- |
| Flow State                    | U/R    | Uncommon | Was Izzet Prowess centerpiece   |
| Lorehold Elder Dragon         | R/W    | Mythic   | 4/5C Control, Selesnya splash   |
| Prismari Elder Dragon         | U/R    | Mythic   | Jeskai Control finisher         |
| Quandrix Elder Dragon         | G/U    | Mythic   | Mono-Green / Simic ramp         |
...
| Card                          | Color  | Rarity   | Role                                |
| ----------------------------- | ------ | -------- | ----------------------------------- |
| College-aligned removal piece | Varies | Rare     | Targeted removal at instant speed   |
| Quandrix counter generator    | G/U    | Rare     | Increment enabler, midrange threat  |
| Lorehold spirit recursion     | R/W    | Rare     | Magecraft fuel, graveyard engine    |
| Witherbloom sacrifice outlet  | B/G    | Rare     | Aristocrats-style finisher          |
| Silverquill token generator   | W/B    | Rare     | Go-wide threat with lifegain        |
| Prismari big spell payoff     | U/R    | Rare     | Cost reducer for Prepare spells     |
| Cycle dual lands (all five)   | Multi  | Rare     | Mana fixing for tri-color builds    |
...
If you want a refresher on which red and blue staples these cards combine with, the [best red cards in Magic: The Gathering](/blog/magic-the-gathering/best-red-cards-magic-the-gathering) and [best blue cards in Magic: The Gathering](/blog/magic-the-gathering/best-blue-cards-magic-the-gathering) breakdowns walk through the core color staples that still anchor every Standard deck.
...
You can cross-reference this with [Draftsim's SSH set review](https://draftsim.com/) for a competing tier list. The two lists agree on roughly 80% of the placements, which is a good sanity check.
...
For a deeper read on the new meta and what to actually build, the [Selesnya Landfall Pro Tour winning deck breakdown](/blog/magic-the-gathering/selesnya-landfall-pro-tour-strixhaven-winning-deck) covers the deck that benefited most from the post-ban shake-up.
...
- Watch [Magic.gg](https://magic.gg/) for the next round of Pro Tour and tournament results to see which B-tier cards climb.
`,
  faq: [
    {
      question: "Is Flow State still good after the Cori-Steel Cutter ban?",
      answer: "Yes. Flow State was the engine that made Izzet Prowess oppressive, not Cori-Steel Cutter. Flow State will find a home in whatever the next viable spells-matter deck is. It was in 34.8% of Pro Tour Strixhaven decks for a reason, and that reason was the card itself, not the shell around it.",
    },
    {
      question: "Which Elder Dragon from Secrets of Strixhaven is the strongest in Standard?",
      answer: "The Witherbloom Elder Dragon is currently the strongest in post-ban Standard because Witherbloom midrange is the tier 1 deck most rewarded by the May 18 ban list. The Quandrix and Lorehold dragons are close behind in Mono-Green Landfall and 4/5C Control respectively. The Silverquill dragon is the one that flopped hardest.",
    },
    {
    ...
    },
    {
      ...
      answer: "Yes, for any player building tri-color or 4-color decks. The cycle dual lands are the cleanest fixing currently in Standard and they enable the 4/5C Control and Jeskai Control decks that are tier 1.5 in the post-ban meta. They are also Commander staples, which gives them long-term floor value.",
    },
    {
      question: "What is Dina's Guidance and why is it so highly rated?",
      answer: "Dina's Guidance is a Witherbloom instant that tutors a creature to your hand or graveyard. Instant-speed creature tutors are rare in Standard, and Witherbloom uses it to either grab an Elder Dragon for the next turn or dump a recursion target into the graveyard for a sacrifice payoff. It is the engine card for Witherbloom midrange.",
    },
    {
      question: "How many SSH cards will actually see Standard play long-term?",
      answer: "Roughly 20-30 out of the 270-plus card set. That is in line with most modern Standard-legal sets. The S-tier and A-tier picks above cover most of the cards that will define the format for the next year, with a handful of B-tier cards likely to climb once new decks are built around them.",
    },
    {
      question: "Will Secrets of Strixhaven still be Standard legal next year?",
      answer: "Yes. There is no Standard rotation in 2026. Rotation resumes with the first 2027 set release, which means SSH cards have at least a full year of Standard legality ahead of them. That is also why the price floor on the S-tier picks is unlikely to drop much in the near term.",
    },
  ],
  internalLinks: [
    ...
    { href: '/blog/magic-the-gathering/selesnya-landfall-pro-tour-strixhaven-winning-deck', anchor: 'Selesnya Landfall Pro Tour winning deck breakdown' },
    { href: '/blog/magic-the-gathering/best-red-cards-magic-the-gathering', anchor: 'best red cards in Magic: The Gathering' },
    { href: '/blog/magic-the-gathering/best-blue-cards-magic-the-gathering', anchor: 'best blue cards in Magic: The Gathering' },
  ],
  externalSources: [
    { url: 'https://magic.gg/', title: 'Magic.gg official tournament coverage' },
    { url: 'https://www.mtggoldfish.com/', title: 'MTGGoldfish Standard metagame data' },
    { url: 'https://scryfall.com/sets/ssh', title: 'Scryfall Secrets of Strixhaven set search' },
    { url: 'https://draftsim.com/', title: 'Draftsim SSH set review' },
    { url: 'https://magic.wizards.com/en/news', title: 'Wizards of the Coast ban announcement archive' },
  ],
};
