...
Smothering Tithe is the white parallel and arguably even more backbreaking. Every card every opponent draws — including their natural draw step every turn — makes you a Treasure token unless they pay two mana. Nobody pays two every turn, so by turn six or seven you are sitting on a pile of Treasures that powers out your entire hand. It is the best [ramp](/blog/magic-the-gathering/best-ramp-spells-commander-mtg) white has ever gotten and it is legal everywhere it is legal to play it, including Modern and Pioneer.
...
- **Mirari's Wake ({3}{G}{W}).** Your creatures get +1/+1, and — the reason it is here — your lands tap for an extra mana of the same type. It is a mana doubler stapled to an [anthem](/blog/magic-the-gathering/best-mtg-anthem-effects), and doubling your mana in a Commander deck means casting two big things a turn instead of one.
...
**Auras are enchantments, but they are usually worse than other enchantments** for one reason: they attach to something, so when that something dies, the Aura dies too, and you have been two-for-oned. The exceptions are auras that replace themselves or generate value on their own — the [reanimation aura](/blog/magic-the-gathering/best-mtg-reanimation-spells) Animate Dead ({1}{B}) brings a creature straight back from any graveyard, which is so much value that the card-disadvantage risk is irrelevant. As a category, though, prefer standalone enchantments over auras unless the aura's effect is worth the fragility.
