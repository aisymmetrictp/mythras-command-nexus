...
import { bestEldenRingStartingClass } from './posts/best-elden-ring-starting-class';
import { eldenRingWeaponScalingExplained } from './posts/elden-ring-weapon-scaling-explained';
...
export const ELDEN_RING_POSTS: BlogPost[] = [
  ...
  eldenRingWeaponScalingExplained,
