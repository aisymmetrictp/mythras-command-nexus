...
export const timekeeperToppings: BlogPost = {
  ...
  toc: [
    ...
    { id: 'topping-substats-priority', label: 'Sub-stat priority order', level: 3 },
    { id: 'best-beascuit', label: 'Best beascuit', level: 2 },
    { id: 'best-topping-tart', label: 'Best topping tart', level: 2 },
    { id: 'best-team-comps', label: 'Best team comps with Timekeeper', level: 2 },
    { id: 'comp-arena', label: 'Comp 1 — Evergreen Arena meta', level: 3 },
    { id: 'comp-guild', label: 'Comp 2 — Guild Battle Machine-God', level: 3 },
    { id: 'comp-tower', label: 'Comp 3 — Cake Tower / PvE push', level: 3 },
    { id: 'how-to-counter-timekeeper', label: 'How to counter Timekeeper if you face her', level: 2 },
