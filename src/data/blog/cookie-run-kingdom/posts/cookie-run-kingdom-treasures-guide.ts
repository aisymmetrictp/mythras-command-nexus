...
export const crkTreasuresGuide: BlogPost = {
  slug: 'cookie-run-kingdom-treasures-guide',
  game: 'cookie-run-kingdom',
  category: 'beginner-guides',
  topicCluster: 'systems-explainer',
  title: 'Cookie Run: Kingdom Treasures Guide — How Treasures Work & Which to Build First',
  metaDescription:
  ...
  secondaryKeywords: [
    ...
    'how do treasures work crk',
    'treasures tier list crk',
    'treasure upgrade guide crk',
    'best treasures for arena',
  ],
  ...
  readingTimeMin: 10,
  toc: [
    { id: 'what-treasures-actually-do-in-crk', label: 'What treasures actually do in CRK', level: 2 },
    { id: 'how-to-get-and-upgrade-treasures', label: 'How to get and upgrade treasures', level: 2 },
    { id: 'where-treasures-come-from', label: 'Where treasures come from', level: 3 },
...
1. **Squishy Jelly Watch.** Reduces team skill cooldowns. The strongest treasure in the game, period. Every burst comp wants it, every sustain comp wants it, and the difference between level 1 and level 5 is roughly an extra full skill rotation in a long fight.
2. **Old Pilgrim's Scroll.** Boosts team ATK and Crit at battle start. Universal pick. Pairs with anything. Even mediocre comps feel sharper with it slotted.
3. **Bookseller's Monocle.** Increases damage dealt when at low HP. Strong with any healer-anchored comp, because your front-line ends fights low and the monocle keeps the damage scaling up as you drop.
4. **Disco-Ball Hairpin.** Damage amp on enemies hit by an AoE. The default third slot for any comp running AoE skills, which is most of them.
5. **Sugar Gnome Tools.** Extra Crit damage. Pairs cleanly with Searing Raspberry, Black Pearl, and any burst comp that wants to make Crit hits hurt more.
6. **Grim-looking Scythe.** DEF down on enemies. This is a damage multiplier for both physical and magic, which means it stacks well with everything and is rarely a wasted slot.
7. **Healing Power-Pack.** Periodic team heal. Niche, but mandatory for Avatar of Destiny and any Guild Battle boss where attrition is the actual problem.
8. **Dazzling Crepe Cape.** Bonus damage on debuffed enemies. Pairs with Ash Salt, Poison Mushroom, and any comp running consistent debuff uptime.
...
If you have not settled on an Arena team yet, the [Kingdom Arena meta team breakdown](/blog/cookie-run-kingdom/kingdom-arena-meta-team) walks through which Cookies pair best with this loadout. For Guild Battle, the [Guild Battle teams guide](/blog/cookie-run-kingdom/guild-battle-teams) covers boss-specific comps that lean on the treasures above.
...
If you have not done your daily Codes run yet, the [CRK codes list](/blog/cookie-run-kingdom/cookie-run-kingdom-codes) usually has Crystals tucked in alongside the Rainbow Cubes. Same with the [Timeline of Fate update guide](/blog/cookie-run-kingdom/timeline-of-fate-update-guide), which tracks event-period Crystal rewards.
...
If you swap Cookies but not treasures, you are running a half-built team. This is the single most common reason an A-tier roster underperforms in Arena. The Cookie tier list ([CRK tier list](/blog/cookie-run-kingdom/cookie-run-kingdom-tier-list)) does not factor in your treasure depth, which means a "lower tier" team with the right treasures will beat a "higher tier" team without them.

For new accounts still building their first roster, the [CRK reroll guide](/blog/cookie-run-kingdom/cookie-run-kingdom-reroll-guide) covers which Cookies are worth chasing in the early game. Pair that with this treasure plan and you will be set up for the first three months without wasting any Crystals.
...
- [ ] Pair this guide with the [Timekeeper toppings guide](/blog/cookie-run-kingdom/timekeeper-toppings) and the [Cake Tower meta plan](/blog/cookie-run-kingdom/kingdom-arena-meta-team) for full kit coverage.
- [ ] Refuse to pull blind on the Fountain until you have a target treasure picked.

## FAQ`,
  faq: [
    {
      question: 'What is the single best treasure in Cookie Run: Kingdom right now?',
      answer:
        'Squishy Jelly Watch. It reduces team skill cooldowns, which scales with every Cookie in your slot, and a level 5 Watch is worth roughly an extra full skill rotation in any 60-second fight. It is the only treasure you should be maxing first regardless of game mode or comp.',
    },
    {
      question: 'How many treasures should I equip per battle?',
      answer:
        'Three. CRK lets you slot three treasures per battle loadout, and you can save separate loadouts for each game mode. Always run three active treasures whenever possible, and only slot an aura if your third option is significantly underbuilt.',
    },
    {
      question: 'Should I focus on active or aura treasures?',
      answer:
        'Actives, in 2026, by a wide margin. Aura treasures cap at battle-start values, while active treasures keep generating value on every cooldown. In a typical Cake Tower or Arena fight, an active treasure will outperform a comparable aura roughly three to one.',
    },
    {
      question: 'How do I farm treasure duplicates without spending Crystals?',
      answer:
        'Use the Mileage shop for guaranteed dupes of whatever you are currently upgrading, clear World Exploration on every refresh for chapter drops, and run the Treasure Fountain only on event days that give discount or doubled pulls. Save Crystals between events instead of spending them on cosmetic frames.',
    },
    {
      question: 'What treasures should I run for Kingdom Arena specifically?',
      answer:
        "Squishy Jelly Watch, Old Pilgrim's Scroll, and Grim-looking Scythe is the default Arena loadout. The Watch compresses your burst window, the Scroll boosts opener damage, and the Scythe applies DEF down to make every hit count. Swap the Scythe for Sugar Gnome Tools if you are running a Crit-heavy burst comp.",
    },
    {
      question: 'When should I stop upgrading a treasure?',
      answer:
        "Stop at level 4 for everything except your top two treasures. The Crystal cost to take a treasure from level 4 to level 5 is roughly equal to taking a fresh treasure from level 1 to level 4, so unless you are already running Squishy Jelly Watch and Old Pilgrim's Scroll at level 5, your Crystals are better spent broadening your pool.",
    },
    {
      question: 'Do treasures matter for new players or only for endgame?',
      answer:
        'They matter from week one. New players who ignore treasures hit a hard wall around World Exploration chapter 12 and Arena Platinum, because their teams are running at roughly 75 percent of their actual power budget. Start upgrading the Watch within your first few days, not after you cap your Cookies.',
    },
  ],
  internalLinks: [
    ...
    { href: '/blog/cookie-run-kingdom/cookie-run-kingdom-codes', anchor: 'CRK codes list' },
  ...
  externalSources: [
    ...
    },
    {
      ...
      title: 'Devsisters — Official Cookie Run portal',
    },
    {
      url: 'https://www.devsisters.com/en/',
      title: 'Devsisters Corp — Official site',
    },
  ],
};
