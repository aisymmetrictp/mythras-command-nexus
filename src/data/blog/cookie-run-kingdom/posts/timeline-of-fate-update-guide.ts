...
export const timelineOfFateUpdateGuide: BlogPost = {
  slug: 'timeline-of-fate-update-guide',
  game: 'cookie-run-kingdom',
  category: 'events-updates',
  topicCluster: 'patch-overview',

  title: 'Is the Timeline of Fate Update Worth It? Beginner-to-Endgame Guide to CRK v7.4',
  metaDescription:
  ...
  primaryKeyword: 'timeline of fate update guide',
  secondaryKeywords: [
    'CRK v7.4',
    'cookie run kingdom timeline of fate',
    'timekeeper cookie release',
    'ash salt cookie',
    'crk 6 star legendary system',
    'arcade arena rewound glory',
    'CRK Act 2 update',
  ],
...
For broader gear context across the new region, the [gear guide index](/gear-guide) covers builds for every Cookie that fits the Ash-Bound team templates, and the [toppings reference](/gear-guide/toppings) covers the new drops.
...
- Re-read the [tier list](/blog/cookie-run-kingdom/cookie-run-kingdom-tier-list) in 2 weeks; the patch cadence shortened, so the meta will move`,
  ...
  faq: [
    {
      question: 'When did Timeline of Fate Act 2 release?',
      answer:
        'Cookie Run: Kingdom v7.4 "Timeline of Fate" Act 2 launched on May 7, 2026. It is the current live patch as of late May 2026, with the Arcade Arena "Rewound Glory" season running through June 4, 2026.',
    },
    {
      question: 'Do I have to play the story to use the new mechanics?',
      answer:
        'You have to clear specific story stages to unlock the Ash-Bound Soul region and the Unstable Timeline / Timeline Reconstruction tutorials. Arcade Arena, Kingdom Affairs, and the 6-star Legendary system unlock without story progression as long as your account meets the minimum level (60 for most).',
    },
    {
      question: 'Should I pull on the Timekeeper banner or save for the next one?',
      answer:
        'Pull on Timekeeper if you play Arena and already have a built healer. She is one of the highest-impact single Cookies released in the past 12 months. If you do not play PvP at all, the value is lower and you can reasonably save crystals for a future banner — but PvE players still benefit from her on the new Beast Raid content.',
    },
    {
      question: 'How does the 6-star Legendary system change F2P strategy?',
      answer:
        'It makes focused investment significantly better than spread investment. Pre-v7.4 you could feed three or four Legendaries simultaneously and stay competitive. With 6-star live, one Legendary at 6-star outperforms two at 5-star. Pick a lane, pick a Cookie, push her to 6-star, then start the next.',
    },
    {
      question: 'Is Arcade Arena replacing Kingdom Arena?',
      answer:
        'No. Arcade Arena is a parallel mode with rotating seasonal rules. Kingdom Arena remains the main competitive ladder. Arcade Arena exists for experimentation, weekly rewards, and seasonal flair, with a separate ranking that does not affect your main Arena rank.',
    },
    {
      question: 'How long does the Rewound Glory season last?',
      answer:
        'The current Arcade Arena season "Rewound Glory" runs through 2026-06-04. After that, a new season with different modifiers will rotate in. Each season is roughly 4 weeks.',
    },
    {
      question: 'Did v7.4 raise the level cap?',
      answer:
        'No — the account level cap stayed at 100, which was raised from 90 during the v7.0 anniversary patch in January 2026. Timeline of Fate Act 2 raised the *Legendary growth ceiling* to 6-star, which is a different system.',
    },
  ],
  ...
  externalSources: [
    ...
    {
      url: 'https://www.pocketgamer.com/cookie-run-kingdom/fifth-anniversary-beyond-the-horizon/',
      title: 'Pocket Gamer — CRK 5th anniversary arc',
    },
    {
    ...
    },
    {
      ...
      title: 'Official Play Cookie Run portal',
    },
  ],
};
