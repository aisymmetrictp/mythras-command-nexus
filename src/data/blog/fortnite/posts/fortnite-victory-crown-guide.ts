...
export const fortniteVictoryCrownGuide: BlogPost = {
  slug: 'fortnite-victory-crown-guide',
  game: 'fortnite',
  category: 'advanced-strategy',
  topicCluster: 'fortnite-fundamentals',
  title: 'Fortnite Victory Crown Guide: How to Get and Keep It',
  metaDescription:
    'How the Fortnite Victory Crown works: earning it by winning or placing high, the Crowned Victory Royale, the XP rewards, and how to actually keep one.',
  excerpt:
  ...
  featuredImagePrompt:
    'A glowing golden Victory Crown hovering above a Fortnite character on a battlefield, other players turning toward it, vibrant stylized game art',
  heroImage: '/images/blog/fortnite/fortnite-victory-crown-guide/victory-crown.webp',
  heroImageAlt:
    'The Fortnite Victory Crown — a glowing gold crown that floats above players who recently won or placed highly.',
  imageSources: [
    {
      src: '/images/blog/fortnite/fortnite-victory-crown-guide/victory-crown.webp',
      sourceUrl: 'https://fortnite.fandom.com/wiki/Victory_Crown',
      license: 'Fandom CC-BY-SA / Epic Games',
    },
    {
      src: '/images/blog/fortnite/fortnite-victory-crown-guide/victory-royale-slate.webp',
  ...
  primaryKeyword: 'fortnite victory crown guide',
  secondaryKeywords: [
    'how to get victory crown fortnite',
    'fortnite crowned victory royale',
    'how to keep victory crown',
    'fortnite victory crown rewards',
    'what is the victory crown fortnite',
    'fortnite crown wins',
  ],
  ...
  readingTimeMin: 11,
  toc: [
    { id: 'what-the-victory-crown-actually-is', label: 'What the Victory Crown actually is', level: 2 },
    { id: 'how-to-earn-a-victory-crown', label: 'How to earn a Victory Crown', level: 2 },
    { id: 'the-crowned-victory-royale', label: 'The Crowned Victory Royale', level: 2 },
    { id: 'what-you-actually-get-for-it', label: 'What you actually get for it', level: 2 },
    { id: 'the-crown-is-a-target-playing-with-a-bounty', label: 'The crown is a target: playing with a bounty', level: 2 },
    { id: 'how-to-actually-keep-the-crown', label: 'How to actually keep the crown', level: 2 },
    { id: 'crown-strategy-by-mode', label: 'Crown strategy by mode', level: 2 },
    { id: 'quick-action-checklist', label: 'Quick Action Checklist', level: 2 },
  ],
  content: `You've seen it: a player jogs past with a glowing gold crown hovering over their head, and every instinct tells you to shoot them. That instinct is correct, and it's the whole design. The **Victory Crown** is Fortnite's way of marking its recent winners and pinning a visible bounty on them, turning "I won last game" into a status symbol you have to earn the right to keep. It's equal parts flex and liability, and most players who get one immediately throw it away because they don't understand the two things it actually does.
...
![The Fortnite Victory Crown — a glowing gold crown that hovers above players who recently won or placed highly.](/images/blog/fortnite/fortnite-victory-crown-guide/victory-crown.webp)
...
![A Fortnite Victory Royale slate — winning a match while wearing a crown turns it into the prized Crowned Victory Royale.](/images/blog/fortnite/fortnite-victory-crown-guide/victory-royale-slate.webp)
...
- [ ] Use the **Crowning Achievement emote** after a crowned win to flex your tracked total`,
  faq: [
    {
      question: 'How do you get a Victory Crown in Fortnite?',
      answer:
        'There are two ways. The first is winning a match — a Victory Royale earns you a crown to carry into your next game. The second is placing highly enough: if you survive deep into a match (into the final handful of players) you can earn a crown even without the win. You do not buy or equip the crown from your locker; you earn it through results, and it appears floating above your character at the start of your next match.',
    },
    {
      question: 'What is a Crowned Victory Royale?',
      answer:
        'A Crowned Victory Royale is winning a match while you are wearing a Victory Crown — a win on top of a win. It is the real achievement the crown system is built around, because you have to win with a visible target over your head and a chunk of the lobby hunting you. Fortnite tracks your total number of Crowned Victory Royales and displays it on the Crowning Achievement emote, so a high crowned-win count is the game\'s main bragging-rights stat.',
    },
    {
      question: 'How do you keep a Victory Crown in Fortnite?',
      answer:
        "You keep a crown by winning or placing highly again in your next match, which is harder because the crown is visible to the whole lobby and makes you a priority target. The trick is to play quieter and more passive than usual: land uncontested, gear up fully, move cover-to-cover, avoid open ground, and prioritize surviving deep over getting kills. You lose a crown by dying, not by getting fewer eliminations, so a crown turns Fortnite into a survival game.",
    },
    {
      question: 'What rewards do you get for the Victory Crown?',
      answer:
        'The core reward is the tracked Crowned Victory Royale count, shown on the Crowning Achievement emote — earning your first crown unlocks the emote that displays your crowned-win total. Across seasons, Epic has also attached bonus XP and season-specific cosmetic unlocks to earning crowns and crowned wins, which makes crown-hunting an efficient battle pass progression path. The specific cosmetics rotate by season, but the XP and bragging-rights core stays consistent.',
    },
    {
      question: 'Why does everyone target me when I have a crown?',
      answer:
        'Because the Victory Crown is visible to every player in the lobby from the moment you drop, and eliminating a crowned player carries extra bragging rights and satisfaction. Players who would normally ignore a distant fight will rotate toward a crown, you get third-partied harder, and in squad modes enemy teams often agree to focus the crowned player first. That visibility is the whole point of the design — the crown is a status you have to defend, not a trophy you keep safe.',
    },
    {
      question: 'Does the Victory Crown make you a target in Zero Build too?',
      answer:
        'Yes, and Zero Build is the hardest mode to defend a crown in. The crown is visible across all the battle royale modes, but in Zero Build you cannot throw up an instant wall when a third party finds you, so a single caught-in-the-open moment can end the run. Cover discipline and positioning are everything — move cover-to-cover, avoid open ground, and prioritize survival over fights even more strictly than you would in Build mode.',
    },
  ],
  internalLinks: [
    { href: '/blog', anchor: 'Mythras blog' },
    { href: '/blog/fortnite', anchor: 'Fortnite coverage hub' },
    { href: '/blog/fortnite/fortnite-endgame-strategy', anchor: 'Fortnite endgame strategy guide' },
  ...
  externalSources: [
    ...
    {
      url: 'https://fortnite.fandom.com/wiki/Victory_Crown',
      title: 'Fortnite Wiki — Victory Crown',
    },
    {
      url: 'https://fortnite.fandom.com/wiki/Victory_Royale',
      title: 'Fortnite Wiki — Victory Royale and Crowned Victory Royale',
    },
  ],
  tldr:
    'The Fortnite Victory Crown is a glowing gold marker you earn by winning a match or placing highly, and it carries into your next game where the whole lobby can see it. Winning while crowned is a Crowned Victory Royale — the stat Fortnite tracks and the real flex, displayed on the Crowning Achievement emote. Because the crown makes you a visible target, keeping one means playing quieter and more passive: land uncontested, move cover-to-cover, avoid open ground, and prioritize surviving deep over kills. You lose a crown by dying, not by getting fewer eliminations, so it effectively turns Fortnite into a survival game.',
  itemList: {
    name: 'How the Fortnite Victory Crown Works',
    items: [
      {
        name: 'Earn it by winning or placing high',
        description:
          'A Victory Royale earns a crown, and so does surviving deep into a match (a high placement threshold). You do not have to top the kill feed.',
      },
      {
        name: 'It carries into your next match as a visible marker',
        description:
          'The crown floats above your character and is visible to the entire lobby from the moment you drop, marking you as a recent winner and a priority target.',
      },
      {
        name: 'Crowned Victory Royale is the real prize',
        description:
          'Winning while wearing a crown is a Crowned Victory Royale. Fortnite tracks the total and shows it on the Crowning Achievement emote — the game\'s main bragging-rights stat.',
      },
      {
        name: 'Keeping one means playing for survival',
        description:
          'Because you are a marked target, defend a crown by playing quieter: land uncontested, move cover-to-cover, avoid open ground, and prioritize placement over kills. You lose it by dying.',
      },
    ],
  },
};
