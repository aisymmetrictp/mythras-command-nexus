...
export const fortniteLoadoutPriorityGuide: BlogPost = {
  slug: 'fortnite-loadout-priority-guide',
  game: 'fortnite',
  category: 'advanced-strategy',
  topicCluster: 'fortnite-fundamentals',
  title: 'Fortnite Loadout Priority: What to Grab First',
  metaDescription:
    'Build a winning Fortnite inventory: weapon roles for close, mid, and long range, plus heals, mobility, and mats — what to pick up first and what to drop.',
  excerpt:
  ...
  featuredImagePrompt:
    'A Fortnite inventory bar laid out with a shotgun, an assault rifle, shield potions, and a mobility item in their slots, clean HUD-style presentation, vibrant stylized game art',
  heroImage: '/images/blog/fortnite/fortnite-loadout-priority-guide/assault-rifle.webp',
  heroImageAlt:
    'A Fortnite assault rifle — the mid-range workhorse that anchors almost every balanced loadout.',
  imageSources: [
    {
      src: '/images/blog/fortnite/fortnite-loadout-priority-guide/assault-rifle.webp',
      sourceUrl: 'https://fortnite.fandom.com/wiki/Assault_Rifle',
      license: 'Fandom CC-BY-SA / Epic Games',
    },
    {
      src: '/images/blog/fortnite/fortnite-loadout-priority-guide/pump-shotgun.webp',
      sourceUrl: 'https://fortnite.fandom.com/wiki/Pump_Shotgun',
      license: 'Fandom CC-BY-SA / Epic Games',
    },
    {
      src: '/images/blog/fortnite/fortnite-loadout-priority-guide/medkit.webp',
  ...
  primaryKeyword: 'fortnite loadout priority',
  secondaryKeywords: [
    'best fortnite loadout',
    'fortnite inventory management',
    'what to pick up first fortnite',
    'fortnite weapon roles',
    'fortnite ideal inventory',
    'fortnite loot priority',
  ],
  ...
  readingTimeMin: 12,
  toc: [
    { id: 'a-loadout-is-a-set-of-roles-not-a-list-of-guns', label: 'A loadout is a set of roles, not a list of guns', level: 2 },
    { id: 'the-close-range-slot', label: 'The close-range slot', level: 2 },
    { id: 'the-mid-range-slot', label: 'The mid-range slot', level: 2 },
    { id: 'the-long-range-slot', label: 'The long-range slot', level: 2 },
    { id: 'heals-are-not-optional', label: 'Heals are not optional', level: 2 },
    { id: 'mobility-and-utility', label: 'Mobility and utility', level: 2 },
    { id: 'mats-fit-the-inventory-too', label: 'Mats fit the inventory too', level: 2 },
...
![A Fortnite Pump Shotgun — the archetype of the close-range slot, built to win in-your-face fights in one or two hits.](/images/blog/fortnite/fortnite-loadout-priority-guide/pump-shotgun.webp)
...
![A Fortnite assault rifle — the mid-range workhorse that handles the distance where most fights are actually decided.](/images/blog/fortnite/fortnite-loadout-priority-guide/assault-rifle.webp)
...
![A Fortnite Medkit — the full-health heal, the kind of healing slot too many players treat as optional and lose fights without.](/images/blog/fortnite/fortnite-loadout-priority-guide/medkit.webp)
...
- [ ] On every pickup, ask **"which role does this fill, and is it empty?"** — drop duplicates`,
  faq: [
    ...
    {
      question: 'What should I pick up first in Fortnite?',
      answer:
        'Grab any weapon the instant you land — landing unarmed next to an opponent loses fast. Then solve your close-range slot, since most eliminations happen up close. Next is a mid-range rifle (close plus mid is the two-gun core that handles most fights), then heals (one slot minimum, two preferred), then a mobility item for rotations and escapes. A long-range weapon comes last and only if your slots and the map call for it.',
    },
    {
      question: 'How many heals should I carry in Fortnite?',
      answer:
        'At least one heal slot is mandatory and two is the comfortable default. Carry a mix: a fast heal (minis, splashes) you can use mid-fight or on the move, and a slow heal (a full-health Medkit or a big shield item) for between fights behind cover. Shields are your effective extra health bar, so prioritize entering every fight at full shield. A loadout of three guns and two heals beats five guns and zero heals in almost every realistic match.',
    },
    {
      question: 'Do I need a sniper or long-range weapon in Fortnite?',
      answer:
        'Not always — long range is the situational, optional role. A sniper or marksman rifle is great on open maps and for passive, distance-based play, but it does nothing in a box fight, and a versatile mid-range rifle already covers a lot of longer engagements. Long range is the first weapon role to cut when slots get tight. Never let a second long-range gun crowd out your heals; the heal is almost always the better pick.',
    },
    {
      question: 'How many weapons should I carry in Fortnite?',
      answer:
        'Usually two to three, leaving room for heals and a mobility item. The reliable core is a close-range weapon plus a mid-range rifle, which handles the majority of fights. Add a third weapon (often a long-range option) only if you still have room for at least one — ideally two — heal slots and a mobility item. Carrying four or five guns with no heals is a broken loadout, no matter how good the guns are.',
    },
    {
      question: 'What should I drop or leave on the ground in Fortnite?',
      answer:
        'Leave duplicate roles (a second shotgun when you already have one, unless it is a clear upgrade), guns you will not actually use for your playstyle, and ammo types for weapons you no longer carry. Avoid stacking one resource at the cost of another — five guns and no heals, or all heals and one weak weapon, are both broken. On every pickup, ask which role the item fills and whether that role is already covered; if it duplicates a covered role without upgrading it, leave it.',
    },
  ],
  internalLinks: [
    ...
    { href: '/blog/fortnite/fortnite-mats-management-guide', anchor: 'Fortnite mats and resource management guide' },
  ...
  externalSources: [
    ...
    },
    {
      ...
      title: 'Fortnite Wiki — weapon types and rarities',
    },
    {
  ...
  tldr:
    "A winning Fortnite loadout is a set of roles, not a list of guns: close range (shotgun or SMG), mid range (assault rifle), at least one heal slot — ideally two — and a mobility item, plus a working bank of mats in Build mode. Long range is situational and the first to cut. Because the gun pool rotates every season, fill empty roles before upgrading filled ones — a grey gun in an open slot beats a gold duplicate. Priority on landing: any weapon, then close range, then a mid-range rifle, then heals, then mobility, then long range last. On every pickup, ask which role it fills and whether that role is already covered.",
  itemList: {
    name: 'Fortnite Loadout Priority Order',
    items: [
      {
        name: '1. Any weapon, immediately',
        description:
          'Landing unarmed next to an opponent loses fast — grab the first gun you see, even a grey one, then upgrade into your roles.',
      },
      {
        name: '2. Close-range weapon',
        description:
          'A shotgun or SMG to win the in-your-face fights, which is where most eliminations happen. The highest-priority weapon role to fill.',
      },
      {
        name: '3. Mid-range rifle',
        description:
          'An assault rifle or general-purpose rifle — the workhorse used in most fights and the slot most worth upgrading in quality over the match.',
      },
      {
        name: '4. Heals',
        description:
          'At least one slot, ideally two — shields first, then health, with a mix of fast and slow heals. Non-negotiable; never run all guns and no heals.',
      },
      {
        name: '5. Mobility / utility item',
        description:
          'A way to rotate, escape, and reposition without spending fighting slots. Saves the deaths that are not even fights — especially vital in Zero Build.',
      },
      {
        name: '6. Long-range weapon (situational)',
        description:
          'A sniper or marksman rifle for open maps and passive play. Optional and the first weapon role to cut when slots get tight.',
      },
    ],
  },
};
