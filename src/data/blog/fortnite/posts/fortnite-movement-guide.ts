...
export const fortniteMovementGuide: BlogPost = {
  slug: 'fortnite-movement-guide',
  game: 'fortnite',
  category: 'advanced-strategy',
  topicCluster: 'fortnite-fundamentals',
  title: 'Fortnite Movement Guide: Sprint, Mantle, Slide, and Reset',
  metaDescription:
    'Master Fortnite movement: tactical sprint, mantling, sliding, hurdling, and jump-resets — how the movement toolkit wins fights and speeds up your rotations.',
  excerpt:
  ...
  featuredImagePrompt:
    'A Fortnite player tactical sprinting and vaulting across rooftops at speed, motion lines trailing, the safe zone behind them, fast fluid movement, vibrant stylized game art',
  heroImage: '/images/blog/fortnite/fortnite-movement-guide/tactical-sprint.webp',
  heroImageAlt:
    'A Fortnite player sprinting through a window opening — movement is how you cross gaps and close fights before the shooting starts.',
  imageSources: [
    {
      src: '/images/blog/fortnite/fortnite-movement-guide/tactical-sprint.webp',
      sourceUrl: 'https://fortnite.fandom.com/wiki/Sprinting',
      license: 'Fandom CC-BY-SA / Epic Games',
    },
    {
      src: '/images/blog/fortnite/fortnite-movement-guide/sliding-mechanic.webp',
      sourceUrl: 'https://fortnite.fandom.com/wiki/Movement',
      license: 'Fandom CC-BY-SA / Epic Games',
    },
    {
      src: '/images/blog/fortnite/fortnite-movement-guide/hurdling.webp',
      sourceUrl: 'https://fortnite.fandom.com/wiki/Movement',
      license: 'Fandom CC-BY-SA / Epic Games',
    },
  ],
  ...
  primaryKeyword: 'fortnite movement guide',
  secondaryKeywords: [
    ...
    'fortnite hurdling',
    'fortnite jump reset',
    'how to move better in fortnite',
  ],
  ...
  readingTimeMin: 12,
  toc: [
    { id: 'movement-wins-fights-before-you-fire', label: 'Movement wins fights before you fire', level: 2 },
    { id: 'tactical-sprint-speed-with-a-cost', label: 'Tactical sprint speed with a cost', level: 2 },
    { id: 'mantling-and-hurdling-climbing-without-stopping', label: 'Mantling and hurdling climbing without stopping', level: 2 },
    { id: 'sliding-cover-distance-and-a-smaller-hitbox', label: 'Sliding cover distance and a smaller hitbox', level: 2 },
    { id: 'jump-resets-and-staying-unpredictable-in-a-fight', label: 'Jump-resets and staying unpredictable in a fight', level: 2 },
    { id: 'chaining-it-together-the-movement-flow', label: 'Chaining it together the movement flow', level: 2 },
    { id: 'movement-in-build-vs-zero-build', label: 'Movement in Build vs Zero Build', level: 2 },
    { id: 'quick-action-checklist', label: 'Quick Action Checklist', level: 2 },
  ],
  content: `The players who feel impossible to kill usually aren't out-aiming you — they're out-moving you. They cross open ground faster, they vault a wall instead of running around it, they slide into cover and pop up at an angle you weren't tracking, and by the time you've adjusted they've already won the trade. Aim gets all the attention, but movement is the layer underneath every fight and every rotation, and it's a skill you can train just like building.
...
![A Fortnite player hurdling over an obstacle mid-run — vaulting keeps your momentum instead of stopping at every wall.](/images/blog/fortnite/fortnite-movement-guide/hurdling.webp)
...
![A Fortnite player sliding across the ground — sliding covers distance fast and shrinks your hitbox into cover.](/images/blog/fortnite/fortnite-movement-guide/sliding-mechanic.webp)
...
- **Build mode integrates movement with building.** You still sprint, slide, and reset, but you also have builds, so movement and construction interleave — you might slide into cover, then box up, then push out with a sprint. Our [Zero Build guide](/blog/fortnite/fortnite-zero-build-guide) goes deeper on the no-build defensive game.
...
- [ ] **Lean on movement hardest in Zero Build** — with no walls, it's your main defense`,
  faq: [
    {
      question: 'What is tactical sprint in Fortnite?',
      answer:
        'Tactical sprint is a burst of extra speed on top of normal running that lets you close gaps, cross open ground, and reposition quickly. It drains a stamina meter, and when that meter empties you slow down and have to let it recover before you can sprint again. Use it deliberately on the dangerous, exposed stretches and bank your stamina under cover so you arrive at fights with enough left to reposition or escape.',
    },
    {
      question: 'What is the difference between mantling and hurdling in Fortnite?',
      answer:
        'Mantling is grabbing a ledge and pulling yourself up onto it — climbing onto a roof, rock, or through a high window you could not otherwise reach. Hurdling is vaulting cleanly over a low obstacle like a fence or low wall without breaking stride. Both let you flow through the environment instead of around it: mantling gets you up to height and new angles, while hurdling keeps your momentum so you do not have to stop at every obstacle.',
    },
    {
      question: 'How does sliding help in Fortnite?',
      answer:
        'Sliding carries your sprint momentum forward while lowering your profile, so you cover ground fast and present a smaller target. The best uses are sliding the last stretch into cover so you tuck behind it at a smaller hitbox, sliding downhill for free speed on rotations, and dropping into a slide mid-fight to suddenly change your hitbox height and break someone tracking your head. It is part movement, part defense.',
    },
    {
      question: 'What is a jump-reset in Fortnite?',
      answer:
        'A jump-reset is jumping and crouching (or jumping and re-aiming) during a fight to break up the predictable up-and-down rhythm of your hitbox, so an opponent tracking you cannot settle their crosshair. Paired with strafing side to side, it makes you genuinely hard to hit. The key is to avoid a fixed rhythm — a predictable jump pattern is as easy to track as standing still, so vary your jumps, crouches, and strafe directions.',
    },
    {
      question: 'Does movement matter more in Zero Build?',
      answer:
        'Yes. In Build mode you can throw up a wall to block shots or a ramp to take height, which covers for positional mistakes. Zero Build has no walls, so your movement and the natural cover are your only defense — sprinting to cover, sliding behind it, mantling to height, and jump-resetting in fights become the entire defensive game. The toolkit matters in both modes, but Zero Build punishes ignoring it much harder.',
    },
    {
      question: 'How do I get better at movement in Fortnite?',
      answer:
        'Treat movement as a skill to drill, not just travel. Practice chaining the tools — sprint into a hurdle, into a mantle, into a slide into cover — until it is one fluid motion instead of stop-start. In fights, build the habit of never standing still: strafe, mix in jump-resets and crouches, and vary your patterns so you are never predictable. Like building, it becomes reflex with reps, and it shows up as you taking less damage crossing the map and winning trades you used to lose.',
    },
  ],
  internalLinks: [
  ...
  externalSources: [
    ...
    {
      url: 'https://fortnite.fandom.com/wiki/Movement',
      title: 'Fortnite Wiki — movement mechanics',
    },
    {
  ...
  tldr:
    'Good Fortnite movement wins fights and rotations before you fire a shot. Tactical sprint is a stamina-limited burst — spend it on exposed stretches and bank it under cover. Mantle and hurdle over terrain to keep momentum and reach surprise angles; slide the last stretch into cover to shrink your hitbox and gain downhill speed; and never fight standing still — strafe and jump-reset to break an opponent\'s tracking, varying your patterns so you stay unpredictable. Chain sprint into hurdle into slide into cover as one flow. Movement matters most in Zero Build, where it replaces the walls you do not have.',
};
