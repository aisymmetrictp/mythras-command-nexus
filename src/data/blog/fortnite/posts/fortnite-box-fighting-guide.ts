...
export const fortniteBoxFightingGuide: BlogPost = {
  slug: 'fortnite-box-fighting-guide',
  game: 'fortnite',
  category: 'advanced-strategy',
  topicCluster: 'fortnite-fundamentals',
  title: 'Fortnite Box Fighting Guide: How to Win 1v1 Build Fights',
  metaDescription:
    'Win Fortnite 1v1 build fights: how to box up, the core edits (door, window, cone), piece control, taking walls, and tunneling someone down for the kill.',
  excerpt:
  ...
  featuredImagePrompt:
    'Two Fortnite players in a tight build fight, walls and ramps thrown up between them, one player editing a window to peek and shoot, fast-paced close-range duel, vibrant stylized game art',
  heroImage: '/images/blog/fortnite/fortnite-box-fighting-guide/battle-royale-cover.webp',
  heroImageAlt:
    'Fortnite Battle Royale gameplay — box fighting is the close-range build duel layered on top of every fight in Build mode.',
  imageSources: [
    {
      src: '/images/blog/fortnite/fortnite-box-fighting-guide/battle-royale-cover.webp',
      sourceUrl: 'https://fortnite.fandom.com/wiki/Fortnite:_Battle_Royale',
      license: 'Fandom CC-BY-SA / Epic Games',
    },
    {
      src: '/images/blog/fortnite/fortnite-box-fighting-guide/build-wall.webp',
      sourceUrl: 'https://fortnite.fandom.com/wiki/Building',
      license: 'Fandom CC-BY-SA / Epic Games',
    },
    {
      src: '/images/blog/fortnite/fortnite-box-fighting-guide/build-ramp.webp',
      sourceUrl: 'https://fortnite.fandom.com/wiki/Building',
      license: 'Fandom CC-BY-SA / Epic Games',
    },
    {
      src: '/images/blog/fortnite/fortnite-box-fighting-guide/build-cone.webp',
      sourceUrl: 'https://fortnite.fandom.com/wiki/Building',
      license: 'Fandom CC-BY-SA / Epic Games',
    },
  ],
  ...
  primaryKeyword: 'fortnite box fighting guide',
  secondaryKeywords: [
    'how to box fight in fortnite',
    'fortnite 1v1 build fight tips',
    'fortnite piece control',
    'fortnite box fighting edits',
    'fortnite tunneling guide',
    'fortnite taking walls',
  ],
  ...
  readingTimeMin: 12,
  toc: [
    { id: 'a-box-fight-is-a-fight-over-walls', label: 'A box fight is a fight over walls', level: 2 },
    { id: 'box-up-first-the-1x1-that-buys-you-time', label: 'Box up first: the 1x1 that buys you time', level: 2 },
    { id: 'the-three-edits-that-win-box-fights', label: 'The three edits that win box fights', level: 2 },
    { id: 'piece-control-owning-the-wall-between-you', label: 'Piece control: owning the wall between you', level: 2 },
    { id: 'taking-walls-and-replacing-theirs', label: 'Taking walls and replacing theirs', level: 2 },
    { id: 'tunneling-and-closing-the-kill', label: 'Tunneling and closing the kill', level: 2 },
    { id: 'common-box-fight-mistakes', label: 'Common box fight mistakes', level: 2 },
...
![Fortnite Battle Royale gameplay — the close-range build duel sits on top of every fight in Build mode.](/images/blog/fortnite/fortnite-box-fighting-guide/battle-royale-cover.webp)
...
![A Fortnite wall build piece — the wall is the single most important piece in a box fight.](/images/blog/fortnite/fortnite-box-fighting-guide/build-wall.webp)
...
![A Fortnite ramp/stair build piece — ramps and floors let you change levels and confirm replaces during a box fight.](/images/blog/fortnite/fortnite-box-fighting-guide/build-ramp.webp)
...
- [ ] Drill the **edit-peek-shoot-reset** loop daily in Creative until it's reflex`,
  faq: [
    {
      question: 'What is box fighting in Fortnite?',
      answer:
        'Box fighting is the close-range Build-mode fight where two players build walls (a box) around themselves and battle by editing openings, taking each other\'s walls, and shooting through the gaps. It is less about raw aim than about piece control — owning the wall between you and your opponent so you decide when it opens. The player who controls the contested piece gets the free shots while the other has to react.',
    },
    {
      question: 'How do you win 1v1 build fights in Fortnite?',
      answer:
        'Box up the moment you take damage to reset the fight, then win the edit war. Master the door, window, and cone edits and reset every edit after you shoot so you are never standing behind an open hole. Take piece control by replacing your opponent\'s wall with your own and re-walling instantly, then tunnel toward them with a covered path and edit in to corner them. Aim only matters after you have won the wall between you.',
    },
    {
      question: 'What is piece control in Fortnite?',
      answer:
        'Piece control is owning the build pieces — especially the wall — between you and your opponent in a close-range fight. When you control that contested wall, you decide when it opens: you edit a door or window, peek, shoot, and close it, while your opponent cannot do the same because the wall is not theirs to edit. You get and hold piece control by taking the wall (placing yours over theirs) and re-walling instantly when they take it back.',
    },
    {
      question: 'What are the most important edits for box fighting?',
      answer:
        'Three edits cover almost every box fight: the door (knock out the bottom-center of a wall for a tall peek-and-shoot opening), the window (open the center segment for a smaller, safer peek that exposes less of you), and the cone or floor edit (to change levels — push up through your roof or drop down on a boxed opponent). The key technique with all of them is edit, peek, shoot, reset — always close the edit back up after you take your shots.',
    },
    {
      question: 'What does tunneling mean in Fortnite?',
      answer:
        'Tunneling is building a covered path — walls on the exposed side, a floor under you, and a ramp or cone overhead — to advance on a boxed opponent while staying protected the whole way. Once the tunnel reaches their box, you take the contested wall and edit straight in, cornering them with fewer and fewer escape routes until they run out of materials or panic-edit an opening you punish. It turns piece control into an actual kill.',
    },
    {
      question: 'How do I get better at box fighting fast?',
      answer:
        'Drill it in Creative, not just in ranked matches. Run an edit course daily and practice the door, window, and cone edits — including resetting each one — until they are reflex. Then play dedicated 1v1 box fight and piece-control maps against real opponents to get reps at the wall-trading game. Twenty focused minutes a day beats two unfocused hours; within a couple weeks the edits stop being something you think about and become something you just do.',
    },
  ],
  internalLinks: [
  ...
  tldr:
    'A Fortnite box fight is a fight over walls, not an aim duel. Box up the instant you take damage to reset, then win the edit war with three edits — the door, the window, and the cone — always resetting each edit after you shoot. Take piece control by replacing your opponent\'s wall with your own and re-walling instantly, then tunnel toward them with a covered path and edit in to corner them. Shoot players through your open edits, never spray walls, and drill the edit-peek-shoot-reset loop in Creative until it is reflex.',
};
