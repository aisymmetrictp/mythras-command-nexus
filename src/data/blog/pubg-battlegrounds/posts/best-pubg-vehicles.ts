...
export const bestPubgVehicles: BlogPost = {
  slug: 'best-pubg-vehicles',
  game: 'pubg-battlegrounds',
  category: 'tier-lists',
  topicCluster: 'pubg-vehicles',
  tags: ['vehicles', 'brdm-2', 'coupe-rb', 'dacia', 'uaz', 'rotations'],
  title: 'Best PUBG Vehicles, Ranked',
  metaDescription:
    'Every PUBG vehicle ranked by speed, durability, and rotation utility — BRDM-2, Coupe RB, UAZ, Dacia, motorcycle, Pickup, boats, and which to grab when.',
  excerpt:
  ...
  featuredImagePrompt:
    'A lineup of PUBG vehicles — the armored amphibious BRDM-2 in front, with a UAZ, Dacia, and the Coupe RB sportscar behind, arranged like a tier-list board',
  heroImage: '/images/blog/pubg-battlegrounds/best-pubg-vehicles/brdm-2.webp',
  heroImageAlt:
    'The BRDM-2, PUBG’s armored amphibious vehicle with bulletproof tires, called in by flare gun.',
  imageSources: [
    {
      src: '/images/blog/pubg-battlegrounds/best-pubg-vehicles/brdm-2.webp',
      sourceUrl: 'https://pubg.fandom.com/wiki/BRDM-2',
      license: 'Fandom CC-BY-SA',
    },
    {
      src: '/images/blog/pubg-battlegrounds/best-pubg-vehicles/coupe-rb.webp',
      sourceUrl: 'https://pubg.fandom.com/wiki/Coupe_RB',
      license: 'Fandom CC-BY-SA',
    },
    {
      src: '/images/blog/pubg-battlegrounds/best-pubg-vehicles/dacia.webp',
      sourceUrl: 'https://pubg.fandom.com/wiki/Dacia_1300',
      license: 'Fandom CC-BY-SA',
    },
    {
      src: '/images/blog/pubg-battlegrounds/best-pubg-vehicles/uaz.webp',
  ...
  primaryKeyword: 'best pubg vehicles',
  secondaryKeywords: [
    'pubg vehicles ranked',
    'best vehicle in pubg',
    'pubg fastest vehicle',
    'pubg vehicle tier list',
    'pubg brdm-2',
    'best pubg car for rotation',
  ],
  ...
  readingTimeMin: 11,
  toc: [
    { id: 'a-vehicle-is-cover-with-a-throttle', label: 'A vehicle is cover with a throttle', level: 2 },
    { id: 'how-were-ranking-these', label: 'How we\'re ranking these', level: 2 },
    { id: 'the-s-tier-the-brdm-2', label: 'The S-tier: the BRDM-2', level: 2 },
    { id: 'a-tier-the-do-everything-rotators', label: 'A-tier: the do-everything rotators', level: 2 },
    { id: 'b-tier-the-speed-demons', label: 'B-tier: the speed demons', level: 2 },
    { id: 'c-tier-fine-in-a-pinch', label: 'C-tier: fine in a pinch', level: 2 },
    { id: 'boats-and-water-vehicles', label: 'Boats and water vehicles', level: 2 },
...
1. **Speed.** How fast it gets you across the map and out of the blue. Late circles can outrun players on foot, so raw pace has real value.
2. **Durability and protection.** How much fire it soaks before it cooks off, and whether it actually shields you. Most vehicles offer poor protection; a couple are genuinely armored.
3. **Utility.** Seat count, off-road handling, amphibious travel, how loud and flippable it is, and how well it fits the squad-rotation job.
...
![The BRDM-2, PUBG's armored amphibious vehicle with bulletproof tires, summoned by firing a flare gun outside the safe zone.](/images/blog/pubg-battlegrounds/best-pubg-vehicles/brdm-2.webp)
...
![The UAZ, PUBG's rugged four-seat off-roader and the best all-around squad rotation vehicle on the large maps.](/images/blog/pubg-battlegrounds/best-pubg-vehicles/uaz.webp)
...
- [ ] Match the vehicle to the terrain and your seat count, not to whatever's closest`,
  faq: [
    {
      question: 'What is the best vehicle in PUBG?',
      answer:
        'The BRDM-2 is the best vehicle in PUBG when you can get it. You call it in by firing a flare gun outside the safe zone, and it parachutes in on any map. It is an amphibious four-seater with bulletproof tires and armor that absorbs a large amount of incoming fire (and reduces blue-zone damage), making it rolling cover you can rotate inside of during the endgame. For vehicles you find on the map, the UAZ is the best all-around squad rotator — four seats, tough, and good off-road.',
    },
    {
      question: 'What is the fastest vehicle in PUBG?',
      answer:
        'The two-seat motorcycle is the fastest vehicle in PUBG overall. Among four-wheeled vehicles, the Coupe RB is the fastest — a vintage two-seat sportscar exclusive to Miramar, edged out for outright top speed only by the motorcycle. Both trade speed for fragility and low seat counts, so they are best as solo or duo speed machines rather than squad movers. Exact top speeds shift as the studio tunes vehicles, but the motorcycle-then-Coupe-RB order at the top is durable.',
    },
    {
      question: 'How do you get the BRDM-2 in PUBG?',
      answer:
        'You summon the BRDM-2 with a Flare Gun. Find a flare gun (it spawns as rare loot or in care packages depending on the map), then fire it into the air while you are outside the safe zone. A plane flies over and parachutes the BRDM-2 down near where you fired. Because it is called in rather than found parked, it is available on every map. It is worth the effort: the bulletproof tires, heavy armor, and amphibious travel make it the strongest rotation and cover vehicle in the game.',
    },
    {
      question: 'What is the best vehicle for a squad in PUBG?',
      answer:
        'The UAZ is the best all-around squad vehicle you will find on the map — it seats four, handles rough terrain and hills well, and is tougher than the road cars like the Dacia. The Pickup Truck is a strong alternative when you want more durability and care less about agility. If anyone on the squad has a flare gun, the BRDM-2 is the best squad vehicle of all because it carries four people behind real armor. Avoid the two-seaters (Coupe RB, motorcycle, Buggy) for full squads.',
    },
    {
      question: 'Are boats worth using in PUBG?',
      answer:
        'Yes, and they are underrated. On maps with significant water like Erangel, Miramar, and Sanhok, the water is often the emptiest, least-watched rotation lane, so a boat can move you safely while everyone else fights over the roads. The PG-117 is a durable four-seat speedboat with a boost — the squad pick. The Aquarail is a two-seat jet ski that is more maneuverable but far flimsier, best for a solo or duo. Just remember boats are loud and leave you exposed on open water, so use them to travel, not to fight.',
    },
    {
      question: 'Which PUBG vehicles are map-specific?',
      answer:
        'Several vehicles are locked to particular maps. The Coupe RB and Mirado are Miramar exclusives built for the desert\'s open distances. The snowmobile is Vikendi-only. The Motor Glider, a powered flying glider, appears on select maps as a niche scouting and rotation tool. Regional flavor vehicles like the Tukshai and Zima show up on specific maps too. The BRDM-2 is the exception that works everywhere because it is called in by flare gun rather than found parked.',
    },
  ],
  internalLinks: [
  ...
  externalSources: [
    {
      url: 'https://www.pubg.com/en/game-info/vehicles/land',
      title: 'PUBG: Battlegrounds — official land vehicles page',
    },
    {
    ...
    {
      url: 'https://pubg.fandom.com/wiki/BRDM-2',
      title: "BRDM-2 — official PLAYERUNKNOWN'S BATTLEGROUNDS Wiki",
    },
  ],
  tldr:
    'The BRDM-2 is the best PUBG vehicle — an armored, amphibious four-seater with bulletproof tires that you call in with a flare gun, making it rolling cover for the endgame. For vehicles you find on the map, the UAZ and Pickup are the best squad rotators, the Coupe RB (Miramar) and motorcycle are the fastest but fragile, the Dacia is a road-only sedan, and the PG-117 boat is the underrated safe lane on water maps. Match the vehicle to the terrain and your seat count, and never drive loudly into a fight.',
  itemList: {
    name: 'Best PUBG Vehicles, Ranked',
    items: [
      { name: 'BRDM-2', description: 'Armored, amphibious four-seater with bulletproof tires, called in by flare gun. The best vehicle in the game.' },
      { name: 'UAZ', description: 'Rugged four-seat off-roader — the best all-around squad rotation vehicle you find on the map.' },
      { name: 'Pickup Truck', description: 'Durable four-seat bruiser — strong squad rotator when you value toughness over agility.' },
      { name: 'Coupe RB', description: 'The fastest four-wheeled vehicle, Miramar-exclusive two-seat sportscar. Speed over protection.' },
      { name: 'Motorcycle', description: 'The fastest vehicle overall and very fragile. Brilliant for aggressive solos and duos.' },
      { name: 'Mirado', description: 'Fast four-seat muscle car on Miramar — great on roads, poor off-road.' },
      { name: 'PG-117', description: 'Durable four-seat speedboat with a boost. The squad water vehicle on water maps.' },
      { name: 'Dacia 1300', description: 'Iconic four-seat road sedan — fine on pavement, bad off-road and lightly protected.' },
      { name: 'Aquarail', description: 'Two-seat jet ski — very maneuverable but flimsy. Solo/duo water travel.' },
      { name: 'Buggy', description: 'Light open-frame two-seater — decent off-road, slow, and offers no cover.' },
    ],
  },
};
