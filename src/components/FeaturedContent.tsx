...
export default function FeaturedContent({ allVideos, loading, channels }: FeaturedContentProps) {
    ...
    return (
      <section className="relative py-20 md:py-28">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <SectionHeader label="Featured" title="LATEST DROP" subtitle="Fresh content hot off the press." />
            ...
            <div className="lg:col-span-3">
              <div className="rounded-2xl glass-panel overflow-hidden animate-pulse">
                ...
                <div className="p-6 space-y-3">
                  ...
                  <div className="h-5 bg-[#1c1c24] rounded w-3/4" />
                  <div className="h-3 bg-[#1c1c24] rounded w-full" />
                </div>
              </div>
            </div>
            <div className="lg:col-span-2 space-y-4">
              {[1, 2, 3].map(i => (
                <div key={i} className="flex gap-4 p-3 rounded-xl glass-panel animate-pulse">
                  <div className="w-36 aspect-video rounded-lg bg-[#1c1c24] shrink-0" />
                  <div className="flex-1 space-y-2 py-2">
                    <div className="h-3 bg-[#1c1c24] rounded w-1/2" />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-6">
          ...
          >
            <a
              ...
              className="group relative block rounded-2xl overflow-hidden glass-panel hover:border-[#8b5cf6]/30 transition-all duration-500"
            >
              <div className="relative aspect-video bg-[#111118] overflow-hidden">
                ...
                <div className="absolute top-3 left-3 flex gap-2">
                  <span className="px-2.5 py-1 rounded-lg bg-[#8b5cf6] text-white text-xs font-bold">LATEST DROP</span>
                  {featured.isShort && (
                    <span className="px-2.5 py-1 rounded-lg bg-[#06b6d4] text-white text-xs font-bold">SHORT</span>
                  )}
                </div>
              ...
              <div className="p-5 md:p-6">
                <div className="flex items-center gap-2 mb-3">
                  ...
                  <span className="text-xs text-[#888898]">{formatRelativeDate(featured.publishedAt)}</span>
                </div>
            ...
            {secondary.map((video, i) => (
              ...
              >
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="group flex gap-4 p-3 rounded-xl glass-panel hover:border-[#8b5cf6]/20 transition-all duration-300"
                >
                  <div className="relative w-36 md:w-40 aspect-video rounded-lg overflow-hidden shrink-0 bg-[#111118]">
                    ...
                    {video.isShort && (
                      <div className="absolute top-1.5 left-1.5 px-1.5 py-0.5 rounded bg-[#06b6d4]/90 text-[10px] font-bold text-white">SHORT</div>
                    )}
                  </div>
