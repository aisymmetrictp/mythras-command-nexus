...
const platformCards = [
  ...
  },
  {
    ...
    color: '#ffffff',
    href: 'https://twitter.com/MythrasCookie',
    status: 'Latest Posts',
    external: true,
  },
];
            ...
            >
              <Link href={`/channels/${channel.slug}`}>
                ...
                >
                  {/* Top accent line */}
                  <div
                    className="absolute top-0 left-6 right-6 h-[2px] rounded-full opacity-50 group-hover:opacity-100 transition-opacity"
                  ...
                  <div className="flex items-start gap-4 mb-4">
                    ...
                    <div className="min-w-0">
                      ...
                      <p className="text-xs text-[#55556a] mt-0.5">{channel.game}</p>
                    </div>
                  </div>
